...
use assignsubmission_forms\local\persistent\value;
use assignsubmission_forms\local\persistent\draft;
use assignsubmission_forms\local\api\forms;
/**
 * Main class for forms submission plugin
 *
 ...
 */
class assign_submission_forms extends assign_submission_plugin {
    ...
    public function get_name() {
        return get_string('pluginname', 'assignsubmission_forms');
    }
    ...
    /**
     * Get the settings for forms submission plugin
     *
    ...
    public function get_settings(MoodleQuickForm $mform) {
        ...
        $fieldsmanager = $OUTPUT->render_from_template('assignsubmission_forms/fieldmanager', [
            'fields' => [],
        ...
        $mform->addElement('hidden', 'assignsubmission_forms_config', json_encode($fields));
        $mform->setType('assignsubmission_forms_config', PARAM_RAW);
        $mform->addElement('hidden', 'assignsubmission_forms_fieldtypes', json_encode($fieldtypes));
        $mform->setType('assignsubmission_forms_fieldtypes', PARAM_RAW);
        $mform->hideIf('fieldmanager', 'assignsubmission_forms_enabled', 'notchecked');
        return;
    }

    /**
     * Save the settings for forms submission plugin
     * @param stdClass $data The data from the form
     * @return bool
     */
    public function save_settings(stdClass $data) {
        $this->set_config('fields', $data->assignsubmission_forms_config ?? '');
        return true;
    }
    ...
    public function get_form_elements($submission, MoodleQuickForm $mform, stdClass $data) {
        ...
        $formjs = $OUTPUT->render_from_template('assignsubmission_forms/forms', []);
    ...
    public function save(stdClass $submission, stdClass $data) {
        ...
        foreach ($data->forms as $fieldid => $value) {
            $set = false;
    ...
    public function view_summary(stdClass $submission, &$showviewlink) {
        ...
        return $OUTPUT->render_from_template('assignsubmission_forms/summary', $templatecontext);
    }
    ...
    public function get_external_parameters() {
        ...
        return ['forms' => new external_value(PARAM_RAW, 'The value for this submission.')];
    }
}
