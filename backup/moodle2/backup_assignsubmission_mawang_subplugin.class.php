...
/**
 * Provides the information to backup forms submissions
 *
 ...
 */
class backup_assignsubmission_forms_subplugin extends backup_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $subpluginelement->set_source_table('assignsubmission_forms_value', ['submissionid' => backup::VAR_PARENTID]);
        return $subplugin;
    }
}
