...
use assignsubmission_forms\local\persistent\field;
...
class restore_assignsubmission_forms_subplugin extends restore_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        // $elepath = $this->get_pathfor('/forms_value');
    ...
    /**
     * Processes one assignsubmission_forms element
     *
     * @param mixed $data
     */
    public function process_assignsubmission_value_forms($data) {
        global $DB;
        ...
        // $DB->insert_record('assignsubmission_forms_value', $data);
    }
